...
class HSVPickerPageAquarium extends StatefulWidget {
  @override
  HSVPickerPageAquariumState createState() => new HSVPickerPageAquariumState();
}

class HSVPickerPageAquariumState extends State<HSVPickerPageAquarium> {
